...
# Origin can be found at - https://github.com/vllm-project/vllm/blob/main/vllm/model_executor/models/idefics2_vision_model.py
...
class Idefics2VisionEmbeddings(nn.Module):
    ...
    def __init__(self, config: Idefics2VisionConfig):
        ...
        self.position_embedding = nn.Embedding(self.num_positions,
                                               self.embed_dim)
    # 🧠 Idefics2VisionEmbeddings - forward
    def forward(self,
...
# 🧠 Idefics2VisionTransformer - Main ViT class
